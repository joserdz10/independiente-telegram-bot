...
No generé una imagen falsa. Revisa la fuente o proporciona una fotografía autorizada antes de publicar.`);
  ...
  patchStory(story.id,{production:prod,status:"produced",final_image_path:imagePath});
